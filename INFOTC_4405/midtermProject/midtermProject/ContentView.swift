...
// create an HStack with the state name which will be repeated per state in a list structure
struct infoStates: View {
    var state: USState
...
// create detailed information of state once it is selected
        ...
        VStack {
            ...
            VStack() {
                VStack(alignment: .leading){
                    ...
                    // State Rank and Density Information
                    VStack(alignment: .leading){
