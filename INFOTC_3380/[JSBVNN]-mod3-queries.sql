...
SELECT agent.AGENT_NAME, customer.CUST_NAME, orders.ORD_DATE, orders.ORD_AMOUNT FROM agents, customer, orders WHERE agents.AGENT_CODE = customer.AGENT_CODE AND order.AGENT_CODE = customer.AGENT_CODE AND customer.CUST_COUNTRY='Canada';
