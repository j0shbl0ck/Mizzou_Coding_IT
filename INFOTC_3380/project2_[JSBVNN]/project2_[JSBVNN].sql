...
-- Write a query to create a view named “managers” to display all the managers. Include the manager’s name (first, last), phone number, email, job title, and department name. [Not created]
...
GROUP BY employees.employee_id;
    ...
    -- Query the managers view to show the number of managers in each department. [Not queried]
    SELECT departments.department_name, COUNT(managers.first_name) AS Number_of_Managers

-- Write a query to create a view named “DependentsByDepartment” to get a count of how many dependents there are in each department. [Not created]
...
GROUP BY departments.department_name;
    ...
    -- Query the DependentsByDepartment view to show the department with the largest number of dependents. This should show the department name and the number of dependents. [Not queried]
    SELECT * FROM DependentsByDepartment ORDER BY Number_of_Dependents DESC LIMIT 1;
...
FROM employees
GROUP BY Hire_Year;
    -- Query the HiresByYear view to show the number of hires in 1997. [Not queried]
